...
mdict = { # A dictionary which holds all the hard coded markers (in the markers file)
    'Wanted'               : ("wanted", "0a5fabc8-fe56-481a-b45a-a9ad6917d0d9"),
    'Harrowed'             : ("harrowed", "661f2771-6b73-414b-b0b1-3e2b50386b71"),
    'Ante'                 : ("Ante", "42f8f2f3-2995-4556-b4d0-374f91811c82"),
    'HNActivated'          : ("High Noon Ability", "836dfd81-805b-489a-a3d6-b55d68ff5a71"),
    ...
    'BulletPlus'           : ("+1 Bullet", "5f740820-4c72-4042-b6eb-dcedc77c82ed"),
    'BulletMinus'          : ("-1 Bullet", "093166b4-fddb-4e67-b6e4-86277faedc91"),
    'Jailbreak'            : ("jailbroken", "692a1ab1-9aa9-49da-aff5-114644da921f"),
    'Winner'               : ("Winner", "eeb5f447-f9fc-46b4-846a-a9a40e575cbc"),
    'FlightOfAngels'       : ("Flight of Angels", "8ba2d501-e8b7-4df0-a168-be2d16b26daf")
}
